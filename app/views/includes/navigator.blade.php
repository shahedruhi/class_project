<div id="user-nav">
    <ul class="btn-group">
        ...
        <li class="btn dropdown" id="menu-notifications"><a href="#" data-toggle="dropdown" data-target="#menu-notifications" class="dropdown-toggle"><i class="fa fa-bell"></i> <span class="text">Notifications</span> <span class="label label-danger">5</span> <b class="caret"></b></a>
            <ul class="dropdown-menu notifications-menu">
                <li class="title"><i class="fa fa-envelope-alt"></i>Notifications<a class="title-btn" href="#" title="Write new message"><i class="fa fa-share"></i></a></li>
                <li class="message-item">
                    <a href="#">
                        <img alt="User Icon" src="img/demo/av1.jpg" />
                        <div class="message-content">
